...
import { Category, User, WatchHistory } from '../../schemas/MongoDB/index.js';
    ...
    async getUser(searchInput) {
        try {
            return await User.findOne({
                ...
                //we are sending user password as it will be needed there in controller for login while validating,
